...
branchRouter.get("", is_authenticated_middleware_1.isAuthenticatedMiddleware, branchController.getAll);
branchRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, branchController.getBranchById);
