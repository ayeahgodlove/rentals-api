...
storeRouter.get("", is_authenticated_middleware_1.isAuthenticatedMiddleware, storeController.getAll);
storeRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, storeController.getStoreById);
