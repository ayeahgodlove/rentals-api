...
roleRouter.get("", is_authenticated_middleware_1.isAuthenticatedMiddleware, roleController.getAll);
roleRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, roleController.getRoleById);
