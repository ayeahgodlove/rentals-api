...
reviewRouter.get("", is_authenticated_middleware_1.isAuthenticatedMiddleware, reviewController.getAll);
reviewRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, reviewController.getReviewById);
