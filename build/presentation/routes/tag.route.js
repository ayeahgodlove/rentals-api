...
tagRouter.get("", is_authenticated_middleware_1.isAuthenticatedMiddleware, tagController.getAll);
tagRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, tagController.getTagById);
